...
class Interpolation(nn.Module):
    def __init__(self, n_resgroups, n_resblocks, n_feats, 
        ...
        self.headConv = conv3x3(n_feats * 4, n_feats*2)
        ...
        self.moduleD = torch.nn.Sequential(
                torch.nn.Conv2d(in_channels=384, out_channels=384, kernel_size=3, stride=1, padding=1),
                torch.nn.ReLU(inplace=False),
                torch.nn.Conv2d(in_channels=384, out_channels=192, kernel_size=3, stride=1, padding=1),
                torch.nn.ReLU(inplace=False),
                ...
                torch.nn.ReLU(inplace=False),
                torch.nn.Upsample(scale_factor=2, mode='bilinear', align_corners=True),
                torch.nn.Conv2d(in_channels=192, out_channels=96, kernel_size=3, stride=1, padding=1),
                torch.nn.ReLU(inplace=False),
                ...
                torch.nn.ReLU(inplace=False),
                torch.nn.Upsample(scale_factor=2, mode='bilinear', align_corners=True),
                torch.nn.Conv2d(in_channels=96, out_channels=48, kernel_size=3, stride=1, padding=1),
                torch.nn.ReLU(inplace=False),
